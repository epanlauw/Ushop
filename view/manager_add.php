        ...
        <div class="container">
            <form action="" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control"  name="id" placeholder="Id" disabled value="Default">
                </div>
                <div class="form-group">
                    <label>Stock Barang</label>
                    <input type="text" class="form-control" required="required" placeholder="Stock" name="stock">
                </div>
                <div class="form-group">
                    <label>Harga Barang</label>
                    <input type="text" class="form-control" required="required" placeholder="Price" name="price">
                </div>
                <div class="form-group">
                    <label>Deskripsi Barang</label>
                    <input type="text" class="form-control" required="required" placeholder="Description" name="desc">
                </div>
