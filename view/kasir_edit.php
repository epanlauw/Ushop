        ...
        <div class="container">
            <form action="" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control"  name="nama" value="<?php echo $result['item_name'];?>" disabled>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" required="required" placeholder="Description" name="price" value="<?php echo $result['item_price'];?>">
                </div>
                <input type="submit" class="btn btn-primary" value="Update" name="update">
                <a href="kasir.php" class="btn btn-danger">Back</a>
            </form>
        </div>
        <br/>
