    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8">
                    <pre><h4>ID      : <?php echo $_SESSION['user']['user_id'];?></h4></pre>
                    <pre><h4>Nama    : <?php echo $_SESSION['user']['first_name'] . ' ' . $_SESSION['user']['last_name'];?></h4></pre>
                    <pre><h4>Role    : <?php echo $_SESSION['user']['role_id'];?></h4></pre>
                    <pre><h4>Alamat  : <?php echo $_SESSION['user']['address']?></h4></pre>
